...
# Read in data
# Serology data
serologyn<-read_excel("C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/monthly_modelinput.xlsx",sheet="raw_serology")
# Adult immunity
immunity_adults<-read_excel("C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/monthly_modelinput.xlsx",sheet="adults")
# Contact matrix
contact<-read_excel("C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/monthly_modelinput.xlsx",sheet="contact2") #contact data
# Population figures
pop<-read_excel("C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/monthly_modelinput.xlsx",sheet="pop") #population data
#seroprevalence<-read_excel("C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/monthly_modelinput.xlsx",sheet="year3")
contact=as.matrix(contact)

# Creates cut off points for age groups
lower_age_groups <- tibble(group=colnames(contact)) %>% #groups by contact colnames
  separate(group, c("low", "high"), sep="-", fill="right") %>% #Separates columns into low and high
  mutate(low=parse_number(low)) %>% #Drops high
  .$low

# Adds year
pop_20=pop %>% mutate(Year=c(rep(19,72),rep(20,72)))

# Creates empty vectors to be used later
...
for(i in 1:5000){
  ...
  # Data combining and something with distributions? 
  ...
  save(out_20,file = "C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/out_20.Rdata")
  
}

data=get(load("C:/Users/jbell/OneDrive/Documents/R/Projects/MSc Summer Project/MscSummerProject/Kenya/ncov_measles_Kenya-master/ncov_measles_Kenya-master/Analysis/out_20.Rdata"))
R=vector(length(5000),mode="list")
pre_COVID_herd=vector(length(5000),mode="list")
COVID_herd=vector(length(5000),mode="list")
